...
export const AVAILABLE_TOOLS: ToolInfo[] = [
  ...
  { name: "remove_issue_labels", description: "Remove one or more labels from an existing Jira issue" },
  { name: "transition_issue", description: "Move an issue to a different status by applying a workflow transition" },
  { name: "get_issue_transitions", description: "List available workflow transitions for an issue" },
  ...
  { name: "get_assigned_issues", description: "Get issues assigned to the current user in a project" },
  { name: "get_pending_assigned_issues", description: "Get issues assigned to the current user that are not done" },
  ...
  { name: "update_issue_description", description: "Replace the description and optionally set labels on an existing Jira issue" },
  ...
  { name: "get_project_sprint", description: "Get sprint details and validate it belongs to a project" },
  { name: "add_issues_to_sprint", description: "Add issues to a sprint" },
  { name: "remove_issues_from_sprint", description: "Move issues out of a sprint back to the backlog" },
  ...
  { name: "move_issues_to_board", description: "Move issues from backlog to a board or rank them on the board" },
  { name: "get_board_details", description: "Get detailed configuration and metadata for a specific board" },
